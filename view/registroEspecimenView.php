...
<div class="contenedor">
    <h2>Registro de Espécimen</h2>

    <div class="card">
        <h3>Clasificación taxonómica y Datos del espécimen</h3>

        <form id="formRegistroEspecimen" method="post" enctype="multipart/form-data">

            <label>Código del Espécimen:</label>
            <input type="text" name="codigo_especimen" placeholder="Ej: UCR-ENT-001" required>

            <label>Recolector:</label>
            <input type="text" name="recolector" placeholder="Nombre de quien recolectó">
            ...
            <select id="orden" name="id_orden">
                ...
                <option value="SP">SP</option> <?php foreach ($ordenes as $orden) { ?>
            ...
            <label>Especie:</label>
            <select id="especie" name="id_especie" required disabled>
                <option value="">Seleccione una especie</option>
            </select>

            <br><br>

            <h3>Ubicación física del espécimen</h3>
            ...
            <label>Ubicación Geográfica (Dirección):</label>
            <input type="text" id="dir_texto" name="ubicacion_geografica" placeholder="Ej: Sendero Principal, Volcán Turrialba">
            ...
            <br><br>
            <button type="submit">Registrar espécimen</button>
        </form>
    </div>
    <div class="card">
        <h3>Listado de especímenes registrados</h3>
        <table>
            <thead>
                <tr>
                    <th>Orden</th>
            ...
            <tbody>
                <?php if (isset($especimenes) && count($especimenes) > 0) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" style="background: #3498db; padding: 8px 12px; margin-bottom: 5px; width: 100%;"
                                    onclick="abrirModalActualizar('<?php echo $e['codigo']; ?>')">
                                    Actualizar
                                </button>
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 20px;">No hay especímenes registrados en la base de datos.</td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
